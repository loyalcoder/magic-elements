...
class Counter extends Widget_Base
{
    ...
    protected function register_counter_controls()
    {
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter', 'magic-elements' ),
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Starting Number', 'magic-elements' ),
        ...
        $this->add_control(
			'counter_number',
			[
				'label'   => esc_html__( 'Ending Number', 'magic-elements' ),
				'type'    => \Elementor\Controls_Manager::NUMBER,
				'min'     => 5,
				'max'     => 10000,
				'step'    => 1,
        ...
        $this->add_control(
			'counter_suffix_one',
			[
				'label'       => esc_html__( 'Number Suffix', 'magic-elements' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Plus', 'magic-elements' ),
			]
		);
        $this->add_control(
			'more_options',
        ...
        $this->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => esc_html__( 'Magic Number', 'magic-elements' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .counter_box' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .counter_box' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			'counter_more_options',
			[
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .counter_box' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .counter_box' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .counter_box' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Number', 'magic-elements' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_responsive_control(
