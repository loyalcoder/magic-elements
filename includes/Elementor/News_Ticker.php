...

{
    ...
    protected function render() {
        ...
        <div <?php echo $this->get_render_attribute_string( 'ticker-container' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?>>
