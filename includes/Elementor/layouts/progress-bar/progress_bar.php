...
<div class="magic-progress-bar">
    <div class="progress-icons-wrapper">
        <?php if ('yes' === $settings['show_icon'] && 'before_title' === $settings['icon_position']) : ?>
            <div <?php echo $this->get_render_attribute_string( 'icon' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?>>
    ...
    <div <?php echo $this->get_render_attribute_string( 'wrapper' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?>>
        <div <?php echo $this->get_render_attribute_string( 'container' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?>>
            <div <?php echo $this->get_render_attribute_string( 'fill' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?>>
                <?php if ('yes' === $settings['display_percentage'] && 'inside' === $settings['percentage_position']) : ?>
                    <span <?php echo $this->get_render_attribute_string( 'percentage' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?>>0%</span>
                <?php endif; ?>
