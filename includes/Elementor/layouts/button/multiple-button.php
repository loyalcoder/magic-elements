        ...
        foreach ($settings['button_list'] as $index => $item) {
            ...
            <div class="bt-item">
                <div class="btn-item-wrapper">
                    <a <?php echo $this->get_render_attribute_string( $link_key ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?>>
                        <span class="btn-icon">
                        <?php 
