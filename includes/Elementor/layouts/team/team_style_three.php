...
?>
<div class="me-team-wrapper me-team-style-three">
	<div class="team-card">
		<div class="img-part">
			<?php
		...
		<div class="content-part">
			<?php if ( ! empty( $settings['team_title'] ) ) : ?>
				<h3 class="team-title"><?php echo esc_html( $settings['team_title'] ); ?></h3>
			<?php endif; ?>

			<?php if ( ! empty( $settings['team_description'] ) ) : ?>
				<p class="team-des"><?php echo esc_html( $settings['team_description'] ); ?></p>
			<?php endif; ?>
		</div>
			...
			<div class="icon-part">
				<div class="magic-team-social-icons">
					<?php foreach ( $settings['social_icon_list'] as $index => $item ) : ?>
						<?php
						$link_key = 'link_style_three_' . $index;
