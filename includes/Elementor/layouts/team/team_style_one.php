      ...
      <?php if (!empty($settings['social_icon_list'])) : ?>
        <div class="magic-team-social-icons">
            <?php foreach ($settings['social_icon_list'] as $index => $item) : ?>
                ...
                ?>
                <a <?php echo $this->get_render_attribute_string( $link_key ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Attributes generated by Elementor API. ?> class="elementor-repeater-item-<?php echo esc_attr($item['_id']); ?><?php echo esc_attr($hover_animation); ?>">
