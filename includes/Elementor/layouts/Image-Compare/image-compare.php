<div class="wrapper">
	<figure class="comparison-wrapper">
        ...
        ?>		
        <span class="comparison-label" data-type="original"><?php echo esc_html($settings['before_image_lebel']); ?></span>
		<div class="compare-img">
            ...
            ?>				
            <span class="comparison-label" data-type="modified"><?php echo esc_html($settings['after_image_lebel']); ?></span>
		</div>
