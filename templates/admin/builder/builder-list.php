        ...
        <div class="magic-elements-preview-item">
            <div class="preview-item-header">
                ...
                $preview_link = add_query_arg([
                    'preview_id' => $list['ID'],
                    'preview_nonce' => wp_create_nonce('post_preview_' . $list['ID']),
                    'preview' => 'true'
                ], get_permalink($list['ID']));
                ?> 
                <div class="preview-item-actions">
                    <a href="<?php echo esc_url($preview_link); ?> " class="preview-link" target="_blank"><?php echo esc_html__('Preview', 'magic-elements'); ?></a>
                    <a href="javascript:void(0)" class="edit-link" data-id="<?php echo esc_attr($list['ID']); ?>"><?php echo esc_html__('Edit Template', 'magic-elements'); ?></a>
